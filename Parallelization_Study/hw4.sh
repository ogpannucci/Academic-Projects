...
## This requests 1 node. 32 cores per node. Change this to 2, if you request 64 nodes.
#SBATCH --nodes=1

## This requests 8 cores 
#SBATCH --ntasks=8
...
#SBATCH --mail-user=opannucci@unm.edu 
...
#    $ conda create --name hopper_openmpi_py3_2023 python=3.9 numpy openmpi mpi4py scipy ipython matplotlib
#      < press y to accept installation of all new packages and the many dependencies > 

module load miniconda3
source activate hopper_openmpi_py3_2023 
########################################################################
########################################################################
